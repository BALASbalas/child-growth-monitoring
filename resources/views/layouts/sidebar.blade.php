    ...
    <nav class="flex-1 overflow-y-auto overflow-x-hidden custom-scroll py-3 space-y-0.5 px-3">
        ...
        <div x-data="{ open: {{ request('vaccinate') == 1 ? 'true' : 'false' }} }">
            ...
            <div x-show="open" x-collapse.duration.200ms>
                ...
                <a href="{{ route('immunizations.index') }}" class="nav-item pl-8 {{ $currentRoute === 'immunizations.index' ? 'active' : '' }}">
                    <svg class="nav-icon" width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                    </svg>
                    <span class="nav-label ml-3">Vaccination Records</span>
                </a>
                <a href="{{ route('immunizations.upcoming') }}" class="nav-item pl-8 {{ $currentRoute === 'immunizations.upcoming' ? 'active' : '' }}">
                    <svg class="nav-icon" width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                    </svg>
                    <span class="nav-label ml-3">Upcoming Vaccinations</span>
                </a>
                <a href="{{ route('immunizations.overdue') }}" class="nav-item pl-8 {{ $currentRoute === 'immunizations.overdue' ? 'active' : '' }}">
                    <svg class="nav-icon" width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                    <span class="nav-label ml-3">Overdue Vaccinations</span>
                </a>
            </div>
        </div>
